...
public class BaseIconFactory implements AutoCloseable {
    ...
    public BitmapInfo createBadgedIconBitmap(@NonNull Drawable icon,
        ...
        if (icon instanceof BitmapInfo.Extender) {
            info = ((BitmapInfo.Extender) icon).getExtendedInfo(bitmap, color, this, scale[0], options.mUserHandle);
    ...
    @Nullable
    protected Drawable normalizeAndWrapToAdaptiveIcon(@Nullable Drawable icon, boolean shrinkNonAdaptiveIcons, @Nullable final RectF outIconBounds,
        ...
        if (shrinkNonAdaptiveIcons && !(icon instanceof AdaptiveIconDrawable)) {
            ...
            if (!(icon instanceof AdaptiveIconDrawable) && !outShape[0]) {
                IconProvider.ThemeData themeData = null;
